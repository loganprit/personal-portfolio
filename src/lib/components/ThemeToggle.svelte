...
<button
  type="button"
  class="inline-flex h-9 w-9 items-center justify-center rounded-md border border-(--border) bg-(--card) text-(--fg) shadow-(--shadow) transition-shadow duration-200 hover:shadow-(--shadow-hover)"
